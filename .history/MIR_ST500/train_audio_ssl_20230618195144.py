...
from huggingface_interface import HuggingFaceWav2Vec2
# import wandb
...
class SVT(sb.Brain):
    def compute_forward(self, batch, stage):
        ...
        logits, lw = self.modules.probe(feats)      # (batch, frame, 2+pitch_class+pitch_octave+2)
        ...
        return onset_logits, offset_logits, pitch_octave_logits, pitch_class_logits, wav_lens, lw

    def compute_objectives(self, predictions, batch, stage):
        """Computes the loss (CTC+NLL) given predictions and targets."""
        # predictions
        onset_logits, offset_logits, pitch_octave_logits, pitch_class_logits, wav_lens, lw = predictions
